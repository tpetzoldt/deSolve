...
outA <- as.data.frame(mebdfi(state,times,FKAmodel,phPars,scenario="A"  ))[-1,]
outB <- as.data.frame(mebdfi(state,times,FKAmodel,phPars,scenario="B1" ))[-1,]
outC <- as.data.frame(mebdfi(state,times,FKAmodel,phPars,scenario="C"  ))[-1,]
