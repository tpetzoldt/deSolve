...
rkMethod <- function(method = NULL, ...) {
  methods <- list(
    ...
    ## Cash-Karp method - td = 1: dense output type '1'
    rk45ck = list(ID = "rk45ck",
         ...
         td = 1,        # special dense output type 1
         stage = 6,
         Qerr = 4),
    ## England Method
    rk45e = list(ID = "rk45e",
    ...
    1.7589857770794226507310510589e-1,0), nrow = 13, ncol = 12, byrow = TRUE), 
    ...
    9.24656277640504446745013574318e-1,1,1), 
                stage = 13, Qerr = 7), 
