...
outA <- as.data.frame(mebdfi(y=y,times,res=FNAResidual,dy=dy,parms=phPars,scenario="A" ))[-1,]
outB <- as.data.frame(mebdfi(y=y,times,res=FNAResidual,dy=dy,parms=phPars,scenario="B1",))[-1,]
outC <- as.data.frame(mebdfi(y=y,times,res=FNAResidual,dy=dy,parms=phPars,scenario="C" , ))[-1,]
