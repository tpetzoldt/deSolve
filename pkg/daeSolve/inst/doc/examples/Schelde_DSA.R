...
outA <- as.data.frame(mebdfi(state,times,DSAmodel,phPars,scenario="A" ))[-1,]
outB <- as.data.frame(mebdfi(state,times,DSAmodel,phPars,scenario="B1"))[-1,]
outC <- as.data.frame(mebdfi(state,times,DSAmodel,phPars,scenario="C" ))[-1,]
