...
times <- c(0,350:405)
require(mebdfi)
outA <- as.data.frame(mebdfi(state,times,OSAmodel,phPars,scenario="A" ))[-1,]
outB <- as.data.frame(mebdfi(state,times,OSAmodel,phPars,scenario="B1"))[-1,]
outC <- as.data.frame(mebdfi(state,times,OSAmodel,phPars,scenario="C" ))[-1,]
