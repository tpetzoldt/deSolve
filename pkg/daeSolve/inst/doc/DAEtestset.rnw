...
DLLres(res="wheelres",time=0.,y=yini,dy=yprime,parms= NULL,
  initfunc=NULL,dllname="daeSolve")
@
...
Karline Soetaert and Jeff Cash (2009). bvpSolve: Solvers for boundary value 
  problems of ordinary differential equations. R package version 1.1.
