...
*DECK DSTODI
     ...
     1   ACOR, WM, IWM, RES, ADDA, JAC, PJAC, SLVS, rpar,ipar )
...
C If MITER = 1, call RES, then JAC, and multiply by scalar. ------------
 100  IRES = 1
      ...
      DO 110 I = 1,LENP
 110    WM(I+2) = 0.0D0
      CALL JAC ( NEQ, TN, Y, S, 0, 0, WM(3), N ,rpar, ipar)
      CON = -HL0
      DO 120 I = 1,LENP
 120    WM(I+2) = WM(I+2)*CON
      GO TO 240
...
C If MITER = 4, call RES, then JAC, and multiply by scalar. ------------
 400  IRES = 1
      ...
      DO 410 I = 1,LENP
 410    WM(I+2) = 0.0D0
      CALL JAC ( NEQ, TN, Y, S, ML, MU, WM(ML3), MEBAND, rpar,ipar)
      CON = -HL0
      DO 420 I = 1,LENP
 420    WM(I+2) = WM(I+2)*CON
      GO TO 570
...
C If MITER = 1, call RES, then JAC, and multiply by scalar. ------------
 100  IRES = 1
      ...
      DO 110 I = 1,LENP
 110    WM(I+2) = 0.0D0
      CALL JAC (NEQ, TN, Y, S, MB, NB, WM(3),WM(LPB),WM(LPC),rpar,ipar)
      CON = -HL0
      DO 120 I = 1,LENP
 120    WM(I+2) = WM(I+2)*CON
      GO TO 260
...
*DECK DPREPI
     ...
     1                   WK, IWK, IPPER, RES, JAC, ADDA,rpar,ipar)
      EXTERNAL RES, JAC, ADDA
CKS: added rpar,ipar
      integer ipar(*)
      double precision rpar(*)      
